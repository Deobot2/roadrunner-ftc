...
@TeleOp(group = "drive")
public class SetVelocityDriverControlComp3 extends LinearOpMode {
    ...
    private DcMotorEx armControlLeft;
    private DcMotorEx armControlRight;
    ...
    public void runOpMode() {
        ...
        armControlLeft = hardwareMap.get(DcMotorEx.class, "armControlLeft");
        armControlRight = hardwareMap.get(DcMotorEx.class, "armControlRight");
    ...
    */
        ...
        while (opModeIsActive()) {
            ...
            armControlLeft.setVelocity(armPower);
            armControlRight.setVelocity(armPower);
