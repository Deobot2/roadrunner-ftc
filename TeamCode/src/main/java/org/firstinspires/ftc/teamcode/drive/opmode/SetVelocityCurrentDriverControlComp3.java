...
@TeleOp(group = "drive")
public class SetVelocityCurrentDriverControlComp3 extends LinearOpMode {
    ...
    */
        ...
        while (opModeIsActive()) {
            ...
            frontRight.setVelocity(frontRightPower*strength);
            frontLeft.setVelocity(frontLeftPower*strength);
            backRight.setVelocity(backRightPower*strength);
            backLeft.setVelocity(backLeftPower*strength);
