...
public class DriveConstants {
    ...
    //public static double TRACK_WIDTH = 11.7525; // in
    //Measurement taken on 1/3/2024, middle of wheel to middle of wheel
     ...
     * small and gradually increase them later after everything is worsking. All distance units are
     * inches.
     */
    public static double MAX_VEL = 33.75;
    public static double MAX_ACCEL = 33.75;
